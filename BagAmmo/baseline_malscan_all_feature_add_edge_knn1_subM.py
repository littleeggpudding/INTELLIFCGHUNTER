...
model = None
feature_type = 'all'
save_dir = f'/data/c/shiwensong/project/baseline_malscan_{feature_type}_M/knn_1'  # 最后save的文件夹
recover_dir = f'/data/c/shiwensong/project/baseline_malscan_{feature_type}_M/knn_1'  # 最后save的文件夹
shap_path = ''
init_num = 100
...
if __name__ == '__main__':
    ...
    # for cal shap value
    sub_model = load_MLP_model(f'./430features_6yearsdataset_1000samples/{feature_type}MLP_knn_1.h5')
