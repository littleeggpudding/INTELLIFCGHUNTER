...
# load model
model = None
save_dir = '/data/c/shiwensong/project/baseline_malscan_avg_M/MLP'  # 最后save的文件夹
recover_dir = '/data/c/shiwensong/project/baseline_malscan_avg_M/MLP'  # 最后save的文件夹
shap_path = ''
init_num = 100
...
if __name__ == '__main__':
    ...
    # for cal shap value
    sub_model = load_MLP_model(f'./430features_6yearsdataset_1000samples/{feature_type}MLP.h5')
    ...
    target_model = load_MLP_model(f'./430features_6yearsdataset_1000samples/{feature_type}MLP.h5')
