...
from utils import cal_4features_avg
...
feature_type = None # # concentrate, avgerage, degree, katz, harmonic, closeness
...
def _fitness_function(pop_score_list):
    ...
    for i in range(len(pop_score_list)):
        # A score represents the probability of malware, the smaller the better
...
def parse_arguments():
    ...
    parser.add_argument('--feature_type', type=str, choices=['concentrate', 'average', 'degree', 'katz', 'closeness', 'harmonic'], required=True,
