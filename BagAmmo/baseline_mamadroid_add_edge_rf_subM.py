...
# load model
model = None
save_dir = '/data/c/shiwensong/project/baseline_mamadroid_M/rf'  # 最后save的文件夹
recover_dir = '/data/c/shiwensong/project/baseline_mamadroid_M/rf'  # 最后save的文件夹
shap_path = ''
init_num = 100
...
if __name__ == '__main__':
    ...
    # for cal shap value
    sub_model = load_MLP_model('./430features_6yearsdataset_1000samples/familyMLP_RandomForest.h5')
