...
# load model
model = None
save_dir = '/data/c/shiwensong/project/baseline_apigraph_M/MLP'  # 最后save的文件夹
...
def _population_score(fcg, pop, save_state=False):
    ...
    for i in range(len(all_pop_score)):
        ...
        sub_score_list.append(-score) # because the smaller the better
...
if __name__ == '__main__':
    ...
    # for cal shap value
    sub_model = load_MLP_model('./430features_6yearsdataset_1000samples/apigraphMLP.h5')
    ...
    target_model = load_MLP_model('./430features_6yearsdataset_1000samples/apigraphMLP.h5')
