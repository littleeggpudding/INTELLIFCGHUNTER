...
# load model
model = None
save_dir = '/data/c/shiwensong/project/baseline_apigraph_M/knn_3'  # 最后save的文件夹
recover_dir = '/data/c/shiwensong/project/baseline_apigraph/knn_3/'  # 最后save的文件夹
shap_path = ''
init_num = 100
...
if __name__ == '__main__':
    ...
    # for cal shap value
    sub_model = load_MLP_model('./430features_6yearsdataset_1000samples/apigraphMLP_knn_3.h5')
    ...
    target_model = load_model('./430features_6yearsdataset_1000samples/apigraphknn_3.pkl')
