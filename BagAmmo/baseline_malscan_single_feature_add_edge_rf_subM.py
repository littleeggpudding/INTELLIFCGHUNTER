...
save_dir = f'/data/c/shiwensong/project/baseline_malscan_{feature_type}_M/rf'  # 最后save的文件夹
recover_dir = f'/data/c/shiwensong/project/baseline_malscan_{feature_type}_M/rf'  # 最后save的文件夹
shap_path = ''
init_num = 100
...
if __name__ == '__main__':
    ...
    #     tmp = tmp[:20]
    #     name.extend(tmp)
    with open(f'/data/b/guoqi/malware/tree_attack_set/selected_RandomForest_{feature_type}.txt', 'r') as file:
        name = file.readlines()
    ...
    # for cal shap value
    sub_model = load_MLP_model(f'./430features_6yearsdataset_1000samples/{feature_type}MLP_RandomForest.h5')
    ...
    target_model = load_model(f'./430features_6yearsdataset_1000samples/{feature_type}3Layers_RandomForest.pkl')
