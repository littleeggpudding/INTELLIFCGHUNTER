...
save_dir = f'/data/c/shiwensong/project/baseline_malscan_{feature_type}_M/MLP'  # 最后save的文件夹
recover_dir = f'/data/c/shiwensong/project/baseline_malscan_{feature_type}_M/MLP'  # 最后save的文件夹
shap_path = ''
init_num = 100
...
def _population_score(fcg, pop, save_state=False):
    ...
    for i in range(len(all_pop_score)):
        ...
        sub_score_list.append(-score) # bigger is better
