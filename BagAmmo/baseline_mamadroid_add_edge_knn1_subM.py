...
# load model
model = None
save_dir = '/data/c/shiwensong/project/baseline_mamadroid_M/knn_1/'  # 最后save的文件夹
...
if __name__ == '__main__':
    ...
    # for cal shap value
    sub_model = load_MLP_model('./430features_6yearsdataset_1000samples/familyMLP_knn_1.h5')
    ...
    target_model = load_model('./430features_6yearsdataset_1000samples/familyknn_1.pkl')
