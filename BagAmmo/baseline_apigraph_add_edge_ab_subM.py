...
# load model
model = None
save_dir = '/data/c/shiwensong/project/baseline_apigraph_M/ab_new'  # 最后save的文件夹
recover_dir = '/data/c/shiwensong/project/baseline_apigraph_M/ab_new'  # 最后save的文件夹
shap_path = ''
init_num = 100
...
if __name__ == '__main__':
    ...
    #     tmp = tmp[:20]
    #     name.extend(tmp)
    with open ('/data/b/guoqi/malware/tree_attack_set/selected_AdaBoost_apigraph.txt', 'r') as file:
        name = file.readlines()
    ...
    # for cal shap value
    sub_model = load_MLP_model('./430features_6yearsdataset_1000samples/apigraphMLP_AdaBoost.h5')
    ...
    target_model = load_model('/data/b/guoqi/icse25/malwareGA/model/apigraph/apigraphAdaBoost.pkl')
