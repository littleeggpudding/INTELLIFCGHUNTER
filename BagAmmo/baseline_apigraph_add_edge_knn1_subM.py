...
# load model
model = None
save_dir = '/data/c/shiwensong/project/baseline_apigraph_M/knn_1/'  # 最后save的文件夹
...
if __name__ == '__main__':
    ...
    # for cal shap value
    sub_model = load_MLP_model('./430features_6yearsdataset_1000samples/apigraphMLP_knn_1.h5')
    ...
    target_model = load_model('./430features_6yearsdataset_1000samples/apigraphknn_1.pkl')
