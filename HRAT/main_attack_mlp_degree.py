...
import myenv_withconstraints_mlp
...
if __name__ == '__main__':
    ...
    seq_save_path = save_path + "/degree_actionseq_mlp"
    ...
    for zidx in tqdm(range(0, len(test_sha256_list))):
        ...
        env = myenv_withconstraints_mlp.CFGModifierEnvConstraints(target_graph=X_test_triple,
                                                              label=y_test,
