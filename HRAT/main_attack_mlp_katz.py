...
import myenv_withconstraints_mlp_katz
...
if __name__ == '__main__':
    ...
    seq_save_path = save_path + "/katz_actionseq_mlp"
    ...
    for zidx in tqdm(range(0, len(test_sha256_list))):
        ...
        env = myenv_withconstraints_mlp_katz.CFGModifierEnvConstraints(target_graph=X_test_triple,
                                                                       label=y_test,
        ...
        feature = env.katz_feature_torch(adj_torch, X_test_sen_idx)
        print('feature:')
