...
import myenv_withconstraints_closeness
import os
import time
...
if __name__ == '__main__':
    ...
    for zidx in tqdm(range(1, len(test_sha256_list))):
        try:
            ...
            constraints_path = args.test_set_cons + '/' + X_test_sha256 + ".txt"
            ...
            env = myenv_withconstraints_closeness.CFGModifierEnvConstraints(target_graph=X_test_triple,
                                                                  label=y_test,
