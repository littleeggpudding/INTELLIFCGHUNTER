...
import myenv_withconstraints_mlp_harmonic
...
if __name__ == '__main__':
    ...
    seq_save_path = save_path + "/harmonic_actionseq_mlp"
    ...
    for zidx in tqdm(range(0, len(test_sha256_list))):
        ...
        env = myenv_withconstraints_mlp_harmonic.CFGModifierEnvConstraints(target_graph=X_test_triple,
                                                              label=y_test,
        ...
        feature = env.getHarmonicCentrality(adj_torch, X_test_sen_idx)
        print('feature:')
