...
import myenv_withconstraints_katz_knn3 as myenv_withconstraints_katz
...
if __name__ == '__main__':
    ...
    seq_save_path = save_path + "/katz_actionseq"
    ...
    for zidx in tqdm(range(0, len(test_sha256_list))):
        ...
        env = myenv_withconstraints_katz.CFGModifierEnvConstraints(target_graph=X_test_triple,
                                                              label=y_test,
        ...
        cur_label, min_dist = env.getlabel(katz)
