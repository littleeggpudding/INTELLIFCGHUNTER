...
# load model
model = None
save_dir = '/data/c/shiwensong/project/baseline_apigraph/MLP'  # 最后save的文件夹
...
if __name__ == '__main__':
    ...
    target_model = load_MLP_model('/data/b/guoqi/icse25/malwareGA/model/apigraph/apigraphMLP.h5')
