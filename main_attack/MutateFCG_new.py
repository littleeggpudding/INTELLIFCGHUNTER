...
#load model
model = None
save_dir = '/data/c/shiwensong/project/all_test_flowdroid/MLP/'#最后save的文件夹
recover_dir = './all_test_mar22_second/MLP/'#最后save的文件夹
shap_path =''
init_num = 100
...
def deal_with_conflict(fcg, individual1, control_group = False):
    ...
    #     file.write(res)
    # print("ori_conflict", ori_conflict)
...
def obtain_new_trainset_single_feature(file_path):
    ...
    train_dataset_dir = f'adversarial_all_MLP_withoutshap.csv'
...
if __name__ == '__main__':
    ...
    #for cal shap value
    MLP_model = load_model('./430features_6yearsdataset_1000samples/allMLP.h5')
    ...
    model = load_MLP_model('./430features_6yearsdataset_1000samples/allMLP.h5')

    obtain_new_trainset_single_feature(f'/data/b/shiwensong/project/malwareGA/task/all_test_withoutshap/MLP/')
    print("done")
    sys.exit()
    ...
    # shap_dir = f'{save_dir}120_samples_MLP.pkl'
    # with open(shap_dir, 'rb') as file:
    #     shap_values = pickle.load(file)
    # shap_values = shap_values[0]
    # print("shap_values", shap_values.shape)

    # target_samples = ['01c9424509a1a13d8079a8075511994da70f7ce6b74745f3f28b7400e48f34f4']
    ...
    for i in range(start_index,end_index):
        ...
        # if target_name not in target_samples:
        #     continue
        ...
        if fcg.used_sensitive_nodes is not None and len(fcg.used_sensitive_nodes) != 0:
            ...
            if Y_probs[0][0] < 0:
                ...
                print("malware")
            #     # print(fcg.apk_name)
                ga(fcg, 40, 100, 300, False, None, True, False)
    ...
    # with open(f'{save_dir}120_samples_MLP.pkl', 'wb') as file:
