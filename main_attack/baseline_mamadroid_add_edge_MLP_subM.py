...
# load model
model = None
save_dir = '/data/c/shiwensong/project/baseline_mamadroid_M/MLP'  # 最后save的文件夹
recover_dir = './all_test_withoutsensitive/MLP/'  # 最后save的文件夹
shap_path = ''
init_num = 100
...
def _population_score(fcg, pop, save_state=False):
    ...
    for i in range(len(all_pop_score)):
        ...
        sub_score_list.append(-score) #because the gcn score represent lager is good
...
if __name__ == '__main__':
    ...
    # for cal shap value
    sub_model = load_MLP_model('./430features_6yearsdataset_1000samples/familyMLP.h5')
    ...
    target_model = load_MLP_model('./430features_6yearsdataset_1000samples/familyMLP.h5')
