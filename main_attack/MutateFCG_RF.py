...
if __name__ == '__main__':
    ...
    #         _graph_path = '/data/b/guoqi/malware/tree_attack_set/succ_gexf/AdaBoost_combined/0_VirusShare_5f212e32b51f9aef8f4043010095041f.gexf'
    #
    # print("fcg nodes", len(fcg.nodes))
    # print("fcg edges", len(fcg.edges))
    #
    # original_path = '/data/b/guoqi/malware/tree_attack_set/selected'
    # success_path = 'data/b/guoqi/malware/tree_attack_set/succ_gexf'
