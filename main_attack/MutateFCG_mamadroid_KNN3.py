...
save_dir = '/data/c/shiwensong/project/mamadroid_test_flowdroid/knn_3/'  # 最后save的文件夹
...
if __name__ == '__main__':
    ...
    # for cal shap value
    MLP_model = load_MLP_model('./430features_6yearsdataset_1000samples/familyMLP_knn_3.h5')
    MLP_model2 = load_model('./430features_6yearsdataset_1000samples/familyMLP_knn_3.h5')
    ...
    model = load_model('./430features_6yearsdataset_1000samples/familyknn_3.pkl')
    ...
    # shap_dir = f'{save_dir}120_samples_knn_3_mamadroid.pkl'
    ...
    # with open(f'{save_dir}120_samples_knn_3_mamadroid.pkl', 'wb') as file:
