...
save_dir = './all_test_mar22/SVM_sub/'#最后save的文件夹
recover_dir = './all_test_mar22/SVM_sub/'#从哪个文件夹里面恢复
...
def _population_score(fcg, pop, save_state = False):
    ...
    all_scores = model.decision_function(pop_feature_list)
...
if __name__ == '__main__':
    ...
    for i in range(start_index, end_index):
        ...
        if fcg.used_sensitive_nodes is not None and len(fcg.used_sensitive_nodes) != 0:
            ...
            score = model.decision_function(combined_feature)
