...
save_dir = '/data/c/shiwensong/project/all_test_flowdroid/knn_1/'#最后save的文件夹
recover_dir = './all_test_mar22_second/knn_1/'#从哪个文件夹里面恢复
...
def ga(fcg, max_generation = 100, pop_num = 100, steps = 500, init_state = False, population = None, sensitive = True, sub = True, group = False, distance = True):
    ...
    for i in range(max_generation):
        ...
        if i == max_generation - 1:
            save_state = True
        cur_pop_label_list, cur_pop_score_list, cur_mlp_pop_list, cur_pop_shap_list = _population_score(fcg, next_gene_population, save_state, sub, distance)
...
def load_benign_and_malware_knn_model():
    benign_path = './430features_6yearsdataset_1000samples/all_benignknn_10.pkl'
    malware_path = './430features_6yearsdataset_1000samples/all_malwareknn_10.pkl'
...
if __name__ == '__main__':
    ...
    model = load_model(f'./430features_6yearsdataset_1000samples/all{model_name}.pkl')
    ...
    for i in range(start_index, end_index):
        ...
        if fcg.used_sensitive_nodes is not None and len(fcg.used_sensitive_nodes) != 0:
            ...
            if score <= 0.0:
                ...
                print("malware")
                # print(fcg.apk_name)
                ga(fcg, 40, 100, 300, False, None, True, True, False, True)
