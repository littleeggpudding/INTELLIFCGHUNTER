...
# load model
model = None
save_dir = '/data/c/shiwensong/project/baseline_malscan/harmonic/MLP'  # 最后save的文件夹
recover_dir = '/data/c/shiwensong/project/baseline_malscan/harmonic/MLP'  # 最后save的文件夹
shap_path = ''
init_num = 100
