...
model = None
MLP_model = None
save_dir = './avg_test_mar22_third/knn_3/'#最后save的文件夹
recover_dir = './avg_test_mar22_second/knn_3/'#最后save的文件夹
    ...
    for i in range(start_index, end_index):
        ...
        if fcg.used_sensitive_nodes is not None and len(fcg.used_sensitive_nodes) != 0:
            ...
            if y_label[0] == 0:
                ...
                # score_list, mlp_score_list, shap_list, label_list = _population_score(fcg, pop)
