...
model = None
MLP_model = None
save_dir = 'test_shap_v2_new_second'#最后save的文件夹
...
if __name__ == '__main__':
    ...
    for i in range(start_index, end_index):
        ...
        failed_graph = failed_graphs[i].replace('\n', '')
        ...
        # fcg, combined_feature, file_name = recover_graph(sample_name, zeros_list, failed_graph_dir)
