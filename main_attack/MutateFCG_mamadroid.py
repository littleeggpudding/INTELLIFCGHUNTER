...
save_dir = '/data/c/shiwensong/project/mamadroid_test_flowdroid/MLP/'  # 最后save的文件夹
...
if __name__ == '__main__':
    ...
    # for cal shap value
    MLP_model = load_model('./430features_6yearsdataset_1000samples/familyMLP.h5')
    ...
    model = load_MLP_model('./430features_6yearsdataset_1000samples/familyMLP.h5')

    # obtain_new_trainset_single_feature(f'/data/b/shiwensong/project/malwareGA/task/mamadroid_test_mar22/MLP/')
    # print("done")
    # sys.exit()
