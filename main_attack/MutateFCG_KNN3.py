...
model = None
MLP_model = None
save_dir = '/data/c/shiwensong/project/all_test_flowdroid/knn_3/'#最后save的文件夹
recover_dir = './all_test_mar22_second/knn_3/'#最后save的文件夹
...
if __name__ == '__main__':
    ...
    for i in range(start_index, end_index):
        ...
        if fcg.used_sensitive_nodes is not None and len(fcg.used_sensitive_nodes) != 0:
            ...
            # all_benign_distance, all_benign_indices = benign_knn_model.kneighbors(combined_feature)
            # all_malware_distance, all_malware_indices = malware_knn_model.kneighbors(combined_feature)
            # benign_distance = (all_benign_distance[0][0] + all_benign_distance[0][1] + all_benign_distance[0][2]) / 3.0
            # malware_distance = (all_malware_distance[0][0] + all_malware_distance[0][1] + all_malware_distance[0][2]) / 3.0
            # score = benign_distance - malware_distance
