...
# load model
model = None
save_dir = '/data/c/shiwensong/project/baseline_mamadroid/rf_random/'  # 最后save的文件夹
recover_dir = '/data/c/shiwensong/project/baseline_mamadroid/rf_random/'  # 最后save的文件夹
shap_path = ''
init_num = 100
...
if __name__ == '__main__':
    ...
    #     tmp = tmp[:20]
    #     name.extend(tmp)
    with open ('/data/b/guoqi/malware/tree_attack_set/selected_RandomForest_mamadroid.txt', 'r') as file:
        name = file.readlines()
    ...
    target_model = load_model('./430features_6yearsdataset_1000samples/family3Layers_RandomForest.pkl')
