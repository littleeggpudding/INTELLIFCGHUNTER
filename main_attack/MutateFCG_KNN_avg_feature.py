...
type = 'avg'
save_dir = f'./{type}_test_mar22_third/knn_1/'#最后save的文件夹
# save_dir = f'./test/knn_1/'#最后save的文件夹
recover_dir = f'./{type}_test_mar22_second/knn_1/'#从哪个文件夹里面恢复
...
if __name__ == '__main__':
    ...
    for i in range(start_index, end_index):
        # if 'b8e24021bec54836921e26a7a8cf14941e26a9dae59d0cfab75fe46dcd557521' not in name[i]:
        #     continue
