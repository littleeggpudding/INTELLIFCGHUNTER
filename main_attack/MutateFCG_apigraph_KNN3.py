...
save_dir = '/data/c/shiwensong/project/apigraph_test_flowdroid/knn_3/'  # 最后save的文件夹
recover_dir = './mamadroid_test_new_mutation_with_shap/knn_3/'  # 最后save的文件夹
shap_path = ''
init_num = 100
...
def recover_graph(original_graph_path, shap_value, failed_graph_dir):
    ...
    for failed_path in failed_graphs:
        ...
        score = (all_benign_distance[0][0] + all_benign_distance[0][1]) / 2.0 - (all_malware_distance[0][0] + all_malware_distance[0][1]) / 2.0
...
if __name__ == '__main__':
    ...
    # for cal shap value
    MLP_model = load_MLP_model('./430features_6yearsdataset_1000samples/apigraphMLP_knn_3.h5')
    MLP_model2 = load_model('./430features_6yearsdataset_1000samples/apigraphMLP_knn_3.h5')
    ...
    model = load_model('/data/b/guoqi/icse25/malwareGA/model/apigraph/apigraphknn_3.pkl')
    ...
    for i in range(start_index, end_index):
        ...
        if non_zero_feature != 0:
            ...
            y_label = model.predict(new_feature)
    ...
    # with open(f'{save_dir}120_samples_knn_3_apigraph.pkl', 'wb') as file:
