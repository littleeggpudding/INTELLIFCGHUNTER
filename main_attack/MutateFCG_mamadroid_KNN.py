...
from FCG_mamadroid import FCG_mamadroid
import random
import numpy as np
...
save_dir = '/data/c/shiwensong/project/mamadroid_test_flowdroid/knn_1/'  # 最后save的文件夹
...
def load_benign_and_malware_knn_model():
    benign_path = './430features_6yearsdataset_1000samples/family_benignknn_10.pkl'
    malware_path = './430features_6yearsdataset_1000samples/family_malwareknn_10.pkl'
...
if __name__ == '__main__':
    ...
    # for cal shap value
    MLP_model = load_MLP_model('./430features_6yearsdataset_1000samples/familyMLP_knn_1.h5')
    MLP_model2 = load_model('./430features_6yearsdataset_1000samples/familyMLP_knn_1.h5')
    ...
    model = load_model('./430features_6yearsdataset_1000samples/familyknn_1.pkl')
    ...
    # shap_dir = f'{save_dir}120_samples_knn_1_mamadroid.pkl'
    ...
    for i in range(start_index, end_index):
        ...
        if non_zero_feature != 0:
            ...
            # print("label", model.predict(new_fecdature))
            ...
            if score <= 0.0:
                ...
                print("malware")
                    # print(fcg.apk_name)
                ga(fcg, 40, 100, 300, False, None, False, False, False)
    ...
    # with open(f'{save_dir}120_samples_knn_1_mamadroid.pkl', 'wb') as file:
