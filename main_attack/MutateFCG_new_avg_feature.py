...
# year = '2023'
save_dir = f'./{type}_test_mar22_third/MLP/'#最后save的文件夹
...
def obtain_new_trainset_single_feature(file_path):
    ...
    train_dataset_dir = f'adversarial_avg_MLP_withoutshap.csv'
...
if __name__ == '__main__':
    ...
    # train_dataset_dir = 'select_6years_train_dataset_for_shap_avg.csv'
    ...
    obtain_new_trainset_single_feature(f'/data/b/shiwensong/project/malwareGA/task/avg_test_withoutshap/MLP/')
    print("done")
    sys.exit()
