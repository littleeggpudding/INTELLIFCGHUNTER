...
import glob
import csv
from testShap import obtain_dataset, load_model, get_shap, get_explainer_shap, get_PermutationExplainer
import numpy as np
import pandas as pd
from mlp import MLP
...
feature_type = 'degree'
save_dir = f'/data/c/shiwensong/project/test_mlp_substitute_with_distance/knn_1/{feature_type}/'#最后save的文件夹
...
if __name__ == '__main__':
    ...
    print("train_dataset", train_dataset.shape)
    # 随机选择100个
    train_dataset = train_dataset.sample(n=10, random_state=42)
    # #
    ...
    # for i in range(0, 1):
        # if 'VirusShare_58bde35ee25f91c57ed7d3509603d824' not in name[i]:
        #     continue
    ...
    # new_shap_values = get_PermutationExplainer(all_samples_features, model)
    ...
    #     print("new_shap_values", new_shap_values[i])
