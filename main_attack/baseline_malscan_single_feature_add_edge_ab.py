...
save_dir = f'/data/c/shiwensong/project/baseline_malscan/{feature_type}/ab/'  # 最后save的文件夹
recover_dir = f'/data/c/shiwensong/project/baseline_malscan/{feature_type}/ab/'  # 最后save的文件夹
shap_path = ''
init_num = 100
